...
#define LINKAGE1 200 //mm  主臂长度    Preprocessor cannot handle decimal point...
// Length of outer support arm     Measure arm lengths precisely and enter 
#define LINKAGE2 214.7 //mm 副臂长度   

#define CENCER_OFFSET 40 //mm  旋转轴偏移量
#define HEAD_OFFSET 58 //mm    头部偏移量

// SCARA tower offset (position of Tower relative to bed zero position) 
// This needs to be reasonably accurate as it defines the printbed position in the SCARA space.
#define SCARA_OFFSET_X 215 //mm   
#define SCARA_OFFSET_Y -100 //mm
#define SCARA_OFFSET_Z 26.1 //mm
...
#define PRINTABLE_RADIUS_MIN 80
...
//#define MOTHERBOARD BOARD_ULTIMAKER //BOARD_RAMPS_13_EFB
#ifndef MOTHERBOARD
  #define MOTHERBOARD 33 //BOARD_MELZI
#endif

// Define this to set a custom name for your generic Mendel,
#define CUSTOM_MENDEL_NAME "DARM"
...
#define Y_MAX_ANGLE 90
#define Y_MIN_ANGLE -90
...
//360/1.8*16/360*6   变速比 108/16
#define DEFAULT_AXIS_STEPS_PER_UNIT   {60,60,60,157}  // default steps per unit for SCARA
#define DEFAULT_MAX_FEEDRATE          {100, 100, 100, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {30,30,30,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
